...
import com.intfocus.hx.util.DisplayUtil;
...
public class LockTableView {
     ...
     * 第一行滚动视图（锁状态）
     */
    private TableHorizontalScrollView mLockScrollView;
    /**
     * 第一行滚动视图（未锁状态）
     */
    private TableHorizontalScrollView mUnLockScrollView;
    /**
     * 表格主视图
     */
...
//            Log.e("每行数据",mTableRowDatas.toString());
    ...
    private void initView() {
        ...
        mLockScrollView = (TableHorizontalScrollView) mTableView.findViewById(R.id.lockHeadView_ScrollView);
        mUnLockScrollView = (TableHorizontalScrollView) mTableView.findViewById(R.id.unlockHeadView_ScrollView);
    ...
    private void creatHeadView() {
        if (isLockFristColumn) {
            ...
            mLockScrollView.setOnScrollChangeListener(new TableHorizontalScrollView.onScrollChangeListener() {
                @Override
            ...
            mUnLockScrollView.setOnScrollChangeListener(new TableHorizontalScrollView.onScrollChangeListener() {
                @Override
                public void onScrollChanged(HorizontalScrollView scrollView, int x, int y) {
                    changeAllScrollView(x, y);
                }
    ...
    private void createLockColumnView() {
        ...
        TableHorizontalScrollView lockScrollViewParent=(TableHorizontalScrollView) lockTableViewContent.findViewById(R.id.lockScrollView_parent);
        //构造锁定视图
        ...
        lockScrollViewParent.setOnScrollChangeListener(new TableHorizontalScrollView.onScrollChangeListener() {
            @Override
            public void onScrollChanged(HorizontalScrollView scrollView, int x, int y) {
                changeAllScrollView(x,y);
            }
    ...
    private void createUnLockColumnView() {
        ...
        TableHorizontalScrollView lockScrollViewParent=(TableHorizontalScrollView) lockTableViewContent.findViewById(R.id.unlockScrollView_parent);
        //构造滚动视图
        LinearLayout scollViewItemContentView=new LinearLayout(mContext);
        LinearLayout.LayoutParams scollViewItemContentViewParams=new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
